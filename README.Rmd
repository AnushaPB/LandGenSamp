...
|  
└───outputs.zip - compressed folder of p3_methods outputs *except for results from genotype_environment.R because they are too large to be committed (these results can be reproduced using the original script and the Dryad data)
```
