...
#test data
```{r}
gsd_df <- get_gsd("/Users/Anusha/Documents/GitHub/LandGenSamp/p2_sampling/data/GNX_mod-K2_phi50_m25_seed3_H50_r30/it--1/spp-spp_0/mod-K2_phi50_m25_seed3_H50_r30_it--1_t-1000_spp-spp_0.csv")
...
env1col<- plasma(100)[as.numeric(cut(sub_df$env1,breaks = 100))]
env2col<- viridis(100)[as.numeric(cut(sub_df$env2,breaks = 100))]
par(mfrow=c(1,2), pty="s")
plot(sub_df$x, sub_df$y, col = env1col, pch=19)
plot(sub_df$x, sub_df$y, col = env2col, pch=19)
```


```{r}
heatmap(e.dist[best_sample,best_sample])
heatmap(g.dist[best_sample,best_sample])
```
