...
loci_df <- read.csv(here(dirname(getwd()), "p3_methods", "test_data/old/nnloci_K2_phi50_m100_seed1_H50_r60.csv"))
gen <- get_gen(here(dirname(getwd()), "p3_methods", "test_data/old/mod-K2_phi50_m100_seed1_H50_r60_it-0_t-1000_spp-spp_0.vcf"))
gsd_df <- get_gsd(here(dirname(getwd()), "p3_methods", "test_data/old/mod-K2_phi50_m100_seed1_H50_r60_it-0_t-1000_spp-spp_0.csv"))
