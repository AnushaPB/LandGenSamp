...
ind_plts <-
  ...
  map(~{
    ...
    scale_fill_manual(values = c("ES" = "#0D0887FF", "G" = "#17c3b2", "R" = "#7678ed", "T" = "#ED7953FF"), guide = "none") +
    scale_shape_manual(values = c("ES" = 21, "G" = 22, "R" = 23, "T" = 24), guide = "none") +
...
site_plts <-
  ...
  map(~{
    ...
    scale_fill_manual(values = c("ES" = "#0D0887FF", "EQ" = "#17c3b2", "R" = "#7678ed"), breaks = c("ES", "EQ", "R"), guide = "none") +
    scale_shape_manual(values = c("ES" = 21, "EQ" = 22, "R" = 23), guide = "none") +
...
pdf(here("figures", "Figure_S4.pdf"), width = 11, height = 4.5)
