...
MEGAPLOT(moddf, "geo_rmse", option = "turbo", max = 3)
MEGAPLOT(moddf, "comboenv_rmse", option = "turbo", max = 1)
```
...
summary_hplot(df, aggfunc = "mean", colpal = "viridis", direction = -1)
```
...
summary_hplot(ydf, aggfunc = "mean", colpal = "viridis", direction = -1)
