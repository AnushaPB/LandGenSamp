...
resdf$p1 <- factor(resdf$p1, ordered=TRUE, levels = as.character(c(npts, 2000)))
resdf$p2 <- factor(resdf$p2, ordered=TRUE, levels = as.character(c(npts, 2000)))
