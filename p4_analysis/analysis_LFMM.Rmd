...
df <- do.call(rbind, lapply(list.files(path = "/Users/Anusha/Documents/GitHub/LandGenSamp/p3_methods/outputs/LFMM/temp/", full.names = TRUE), read.csv))
df[,colnames(params_full)] <- data.frame(lapply(df[,colnames(params_full)], as.factor))

colnames(df) <- c(colnames(df)[1:10], "TPRCOMBO", "FDRCOMBO", "TPR1COMBO", "FDR1COMBO", "TPR2COMBO", "FDR2COMBO", 
                  "TPR1", "FDR1", "TPR2", "FDR2")
