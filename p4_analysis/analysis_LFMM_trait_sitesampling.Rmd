...
df <- do.call(rbind, lapply(list.files(path = "/Users/Anusha/Documents/GitHub/LandGenSamp/p3_methods/sitesampling/outputs/LFMM_trait/", full.names = TRUE, pattern="*.csv"), read.csv))
