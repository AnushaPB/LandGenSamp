...
#df <- read.csv("/Users/Anusha/Documents/GitHub/LandGenSamp/p3_methods/sitesampling/outputs/LFMM_trait/LFMM_trait_sitesampling_results.csv")

df <- do.call(rbind, lapply(list.files(path = "/Users/Anusha/Documents/GitHub/LandGenSamp/p3_methods/sitesampling/outputs/LFMM_trait_test/", full.names = TRUE, pattern="*.csv"), read.csv))
