...
df <- do.call(rbind, lapply(list.files(path = "/Users/Anusha/Documents/GitHub/LandGenSamp/p3_methods/outputs/RDA/", full.names = TRUE, pattern="*.csv"), read.csv))
...
MEGAPLOT(moddf, "TPR", max = 0.7, option = "turbo")
MEGAPLOT(moddf, "COMBO")
```
