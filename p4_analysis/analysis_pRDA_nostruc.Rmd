...
#df <- read.csv("/Users/Anusha/Documents/GitHub/LandGenSamp/p3_methods/outputs/RDA/RDA_results.csv")

df <- do.call(rbind, lapply(list.files(path = "/Users/Anusha/Documents/GitHub/LandGenSamp/p3_methods/outputs/RDA_nostruc/", full.names = TRUE, pattern="*.csv"), read.csv))
...
MEGAPLOT(moddf, "TPRCOMBO", max = 0.20, option = "turbo")
#MEGAPLOT(cdf, "TPRCOMBO_corrected", max = 0.05, min = -0.5, option = "turbo")
MEGAPLOT(moddf, "FDRCOMBO")
MEGAPLOT(moddf, "FPRCOMBO")
MEGAPLOT(moddf, "TNRCOMBO")
```
