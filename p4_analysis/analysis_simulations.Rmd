...
Phenotype-environment correlations are significant in all but one of the 960 simulation runs:
...
Genotype-environment correlations at adaptive loci are significant 79% of the time across all simulations and both environmental variables:
```{r}
...
Mean and standard deviation of genotype-environment correlations at adaptive loci across low and high spatial autocorrelation (H):
```{r}
# grouped by H
moddf %>%
  group_by(H) %>% 
