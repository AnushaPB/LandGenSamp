...
for(i in 1:nrow(params)){
  ...
  sub$ratio_ae <- abs(sub$ratio - full$ratio)
  sub$ratio_e <- sub$ratio - full$ratio
  sub$ratio_te <- atan(abs(sub$ratio - full$ratio)/abs(full$ratio))
  sub$ratio_re <- abs(sub$ratio - full$ratio)/(abs(full$ratio) + 1)
