...
#df <- read.csv("/Users/Anusha/Documents/GitHub/LandGenSamp/p3_methods/outputs/LFMM_trait/LFMM_trait_results.csv")

path <- here(dirname(getwd()),"p3_methods","outputs","LFMM_trait")
...
MEGAPLOT(moddf, "TPRCOMBO", max = 1, option = "turbo")
