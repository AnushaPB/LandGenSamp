...
df <- read.csv("/Users/Anusha/Documents/GitHub/LandGenSamp/p3_methods/outputs/mmrr_indsampling_results.csv")
...
# TEMP: removed
#write_csv(new_df, here("p3_methods", "outputs", "mmrr_indsampling_results.csv"))
...
MEGAPLOT(moddf, "ratio_mae", option = "turbo", na.rm = TRUE)
```
