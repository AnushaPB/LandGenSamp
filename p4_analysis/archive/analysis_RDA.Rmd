...
df <- read.csv("/Users/Anusha/Documents/GitHub/LandGenSamp/p3_methods/outputs/rda_indsampling_results.csv")
...
summary_hplot(df, "FDR", direction = -1)

summary_hplot(df, "TPR", aggfunc = "var")

summary_vplot(df, "FDR")
```
