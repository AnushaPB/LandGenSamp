...
df <- do.call(rbind, lapply(list.files(path = "/Users/Anusha/Documents/GitHub/LandGenSamp/p3_methods/outputs/pRDA/", full.names = TRUE, pattern="*.csv"), read.csv))
...
```{r fig.width = 30, fig.height=15}
MEGAPLOT(moddf, "TPRCOMBO", max = 0.1, option = "turbo")
