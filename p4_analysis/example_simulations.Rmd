...
ggplot(dfw, aes(x = xw, y = yw, col = zw)) + 
  ...
  geom_rect(xmin = 0, xmax = 0.13, ymin = 0.42, ymax = 0.48, 
            fill = "white", col = "white", lwd = 2, alpha = 0.2) +
  geom_rect(xmin = 0.52, xmax = 0.65, ymin = 0.42, ymax = 0.48,
            fill = "white", col = "white", lwd = 2, alpha = 0.2) +
  annotate("text", x = 0.05, y = 0.45, label = "Trait 1", col = "darkgray", size = 6) +
  annotate("text", x = 0.57, y = 0.45, label = "Env 1", col = "darkgray", size = 6) +
