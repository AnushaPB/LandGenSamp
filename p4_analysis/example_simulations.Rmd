...
ind_samples <-
  ...
  mutate(sampstrat = case_when(sampstrat == "rand" ~ "R", 
                           ...
                           sampstrat == "envgeo" ~ "EG",
                           sampstrat == "trans" ~ "T")) %>%
  mutate(sampstrat = factor(sampstrat, levels = rev(c("T", "R", "G", "EG"))))
...
site_samples <-
  ...
  mutate(sampstrat = case_when(sampstrat == "rand" ~ "R", 
                           sampstrat == "equi" ~ "EQ",
                           sampstrat == "envgeo" ~ "EG")) %>%
  mutate(sampstrat = factor(sampstrat, levels = rev(c("R", "EQ", "EG"))))
...
pdf(here("figures", "sampling_plots.pdf"), width = 11, height = 6.5)
