...
#df <- read.csv("/Users/Anusha/Documents/GitHub/LandGenSamp/p3_methods/yosemite/outputs/LFMM/LFMM_results.csv")

df <- do.call(rbind, lapply(list.files(path = "/Users/Anusha/Documents/GitHub/LandGenSamp/p3_methods/yosemite/outputs/LFMM/", full.names = TRUE, pattern="*.csv"), read.csv))
